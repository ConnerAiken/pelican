...
const MapWithADirectionsRenderer = compose(
  ...
  <GoogleMap
    ...
    {props.stores.slice(0).map(store => <Marker onClick={props.onSelect.bind(this, store)} value={store} title={store.name} position={{ lat: parseFloat(store.lat), lng: parseFloat(store.lng)}} options={{icon: 'https://developers.google.com/maps/documentation/javascript/examples/full/images/beachflag.png'}} opacity={.25}/>)}
  </GoogleMap>
);
